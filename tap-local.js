      ...
      if (t && t.webModifications && t.webElements) {
        ...
        t.webModifications.forEach(function(r) {
          if (r) {
            ...
            t.urlRules && s.matchUrlRules(t.urlRules, e)
...
Taplytics.init('fd1e0c78e8c041798002726a30d9d4ff', {
  config: {
    ...
    expVarsIds: {
      '5d599e4a9f3fdc000d6d2d00': '5d599e4a9f3fdc000d6d2d03',
    ...
    webElements: [
      {
        ...
        selector:
          'body>div#root:nth-child(2)>div:nth-child(1)>div:nth-child(2)>h1:nth-child(1)',
    ...
    webModifications: [
      {
        _id: '5d599e582e8418000ec9f74e',
        _element: '5d5838512e8418000ec9db43',
        __v: 0,
        attributes: {
          outerHTML: '<h1 class="header">About 123</h1>',
          innerText: 'About 123',
          childSrc: null,
          script: null,
        },
    ...
    app_user_id: '5d5985680ae796001bf886f9',
  },
})
