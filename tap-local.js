...
, function(t, e, r) {
      ...
      if (t) {
          ...
          if (a) {
              ...
              try {
                  ...
                  return s.error("Session.get(" + t + ") failed to parse JSON.", e, s.DEBUG),
                  u
              }
          }
      }
  ...
  e.set = function(t, r, n) {
      ...
      var i = e.getCookieSessionID()
        ...
        , s = E()
        , a = r;
      return !!o && (n && JSON && JSON.stringify && (a = JSON.stringify(r)),
      O(o, a, {
          expires: s
      }),
      !0)
  ...
  e.updateCookieSession = function() {
      ...
      s.log("Set cookieSessionID to: " + t, {
          expires: r
      }, s.LOUD),
      e
  }
  ...
  e.setDeviceUUID = function(t) {
      return (t = t || e.getDeviceUUID()) || (t = o.v4()),
      O(m, t, {
  ...
  e.resetUserID = function() {
      return u.userBucketing ? e.setUserID(null) : i.expire(g),
      e
  }
  ,
  ...
  e.getDeviceUUID = function() {
      ...
      if (t)
          return t;
      var r = i.get(m);
      return t === r && e.deleteSessionUUID(),
      r
  }
  ,
  ...
  e.getSessionAttributes = function(t) {
      ...
      var e = l.toObject()
        , r = c();
      return t.sid = this.getSessionID(),
      ...
      navigator && navigator.userAgent && (t.prms.userAgent = navigator.userAgent),
      t
  }
  ,
  e.saveSessionConfig = function(t, r) {
      r && !t && (s.log("Using cached config because of server error", null, s.DEBUG),
      t = e.getCachedConfig()),
      e.config = t,
      D = !0,
      t && t.app_user_id && t.session_id && (e.hasLoadedData = !0,
  ...
  e.sessionConfigPromise = function(t) {
      if (t)
          return e.hasLoadedData && e.config ? t(!0) : void k.push(t)
  }
  ;
  var D = !1
    , S = new f({
  ...
  e.configPromise = function(t) {
      if (t)
          return D && e.config ? t(!0) : void S.push(t)
  }
  ,
...
, function(t, e, r) {
  ...
  e.get = p(function(t, r, i) {
      ...
      n.get(a).query(s.query).timeout(e.timeout).end(f(a, i))
  }),
  e.getJSON = p(function(t, r) {
      ...
      n.get(s).timeout(e.timeout).end(f(s, r))
  }),
  e.post = p(function(t, e, r, i) {
      ...
      n.post(a).query(s.query).set("Content-Type", "application/json").send(s.payload).end(f(a, i))
  }),
  e.del = p(function(t, r, i, s) {
      ...
      n.del(c).query(a.query).set("Content-Type", "application/json").timeout(e.timeout).send(a.payload).end(f(c, s))
  });
  function f(t, e) {
      return function(r, n) {
  ...
  function h() {
      if (!c.isEmpty()) {
          l = !0;
          var t = c.dequeue();
          return o.log("Processing request", t, o.DEBUG),
  ...
  function d(t, e) {
      var r = i()
        , n = r.eventsAPI
        , o = r.baseAPI;
      return ("events" === t && n ? n : o) + (t || "") + function(t) {
  ...
  function v(t, r) {
      var n = {}
        , i = {};
      return t && "function" == typeof t ? n = t() : t && (n = t),
  ...
  e.setTimeout = function(t) {
      var r = 1e3 * t;
      r > 3e4 ? (o.error("Timeout is larger then max timeout! timeout: " + t + "s, max timeout: 30s. Using max timeout value.", null, o.USER),
      e.timeout = 3e4) : r < 1e3 ? (o.error("Timeout is smaller then the min timeout! timeout: " + t + "s, min timeout: 1s. Using min timeout value.", null, o.USER),
      e.timeout = 1e3) : (o.log("Set timeout: " + t + "s", null, o.LOUD),
      e.timeout = r)
  }
}
, function(t, e, r) {
  ...
  var n = r(0)
    ...
    , l = r(12).OPT_OUT_KEY;
  s.supported() || (n.log("Local Storage not supported", null, n.DEBUG),
  s = null);
  var f = {
  ...
  e.getJSON = function(t, r) {
      ...
      try {
          ...
          return n.error("JSON parse cookie value", t, n.DEBUG),
          null
      }
  }
  ,
  e.getLS = function(t) {
      if (!s)
          return null;
      var e = s.get(t);
      return n.log("Got local storage key: " + t + " with value: " + e, null, n.LOUD),
      e
  }
  ,
  e.get = function(t, r) {
      if (e.getCookieSupport() && !r) {
          var n = h()
            ...
            , a = n.getCookie(t, o);
          return a && !i.includes(i.values(f), t) && (a.value = function(t) {
              try {
  ...
  e.set = function(t, r, o, a) {
      if (t)
          if (e.getCookieSupport() && !a) {
              ...
              var c = h()
                , l = function(t, r, n) {
                  i.includes(i.values(f), t) || (o = r,
                  r = btoa(encodeURIComponent(o)));
                  var o;
                  var s = new u(t + "=" + r);
                  n && (s.expiration_date = n);
                  return s.domain = e.getCookieDomain(),
                  s
  ...
  e.setLS = function(t, e, r) {
      if (s) {
          ...
          s.set(t, e, i),
          n.log("Setting local storage key: " + t + " to value: " + e, null, n.LOUD)
      }
  }
  ,
  e.expire = function(t, r) {
      e.getCookieSupport() && !r ? e.set(t, "-", {
          expires: new Date
      }) : s ? (n.log("Deleting local storage key: " + t, null, n.LOUD),
      s.remove(t)) : r && e.expire(t)
  }
  ;
  var p = void 0;
  function h() {
  ...
  e.getCookieDomain = function() {
      ...
      return r && r.length >= 3 && r[1].match(/^(com|edu|gov|net|mil|org|nom|co|ca|name|info|biz)$/i) ? "." + r[2] + "." + r[1] + "." + r[0] : r && r.length > 1 ? "." + r[1] + "." + r[0] : null
  }
  ,
  e.hasUserOptedOutTracking = function() {
      var t = e.getLS(l);
      return null === t ? null != s && (s.set(l, !1, null),
      n.log("Setting local storage key: " + l + " to value: " + !1, null, n.LOUD),
      !1) : t
  }
  ,
  ...
  e.getCookieSupport = function() {
      ...
      do {
          ...
          if (document.cookie = t ? e + "; expires=" + new Date("Tue, 01-Jan-2030 00:00:00").toUTCString() : e,
          -1 !== document.cookie.indexOf(e))
              return document.cookie = e + "; expires=" + new Date("Sat, 01-Jan-2000 00:00:00 GMT").toUTCString(),
              d = t,
              t
      } while (!(t = !t));return d = null,
      null
  }
}
, function(t, e, r) {
  ...
  t.exports = function() {
      ...
      if ("production" === t.env ? (e.baseAPI = "https://api.taplytics.com/public_api/v1/",
      e.eventsAPI = "https://ping.taplytics.com/public_api/v1/") : "dev" === t.env || "development" === t.env ? e.baseAPI = "https://dev.taplytics.com/public_api/v1/" : "stag" === t.env || "staging" === t.env ? e.baseAPI = "https://staging.taplytics.com/public_api/v1/" : "local" === t.env && (e.baseAPI = "http://localhost:3002/public_api/v1/"),
      ...
      return e.eventsFlushQueueTimeout = 4e3,
      e.functionFlushQueueTimeout = 500,
      e.sdkVersion = "2.12.0",
      e.cookieDomain = t && t.api && t.api.config && t.api.config.cookieDomain ? t.api.config.cookieDomain : null,
...
, function(t, e, r) {
  ...
  var n = {};
  function i(t) {
      return n[t] ? n[t] : "title" === t ? document.title : document.location ? document.location[t] : null
  }
  e.toObject = function() {
      return {
          href: i("href"),
...
, function(t, e) {
  !function() {
      ...
      function r(t, e, n) {
          return t instanceof r ? t : this instanceof r ? (this.name = null,
          this.value = null,
      ...
      function i() {
          var t, e;
          return this instanceof i ? (t = Object.create(null),
          this.setCookie = function(n, i, o) {
              var s, a;
              if (s = (n = new r(n,i,o)).expiration_date <= Date.now(),
              void 0 !== t[n.name]) {
                  for (e = t[n.name],
                  a = 0; a < e.length; a += 1)
                      if (e[a].collidesWith(n))
                          return s ? (e.splice(a, 1),
...
, function(t, e, r) {
  ...
  e.config = r(27),
  e.init = function(t) {
      return !!(t && t._in && t._in.token) && !!this.request.setPublicToken(t._in.token)
  }
}
, function(t, e, r) {
  "use strict";
...
, function(t, e, r) {
  ...
  e.merge = function(t, r, i) {
      ...
      if ("object" != typeof t)
          return [t].concat(r);
      var o = t;
      return Array.isArray(t) && !Array.isArray(r) && (o = e.arrayToObject(t, i)),
      Array.isArray(t) && Array.isArray(r) ? (r.forEach(function(r, o) {
          n.call(t, o) ? t[o] && "object" == typeof t[o] ? t[o] = e.merge(t[o], r, i) : t.push(r) : t[o] = r
      }),
      t) : Object.keys(r).reduce(function(t, o) {
          var s = r[o];
          return n.call(t, o) ? t[o] = e.merge(t[o], s, i) : t[o] = s,
          t
      }, o)
  }
  ,
  ...
  e.encode = function(t) {
      ...
      for (var e = "string" == typeof t ? t : String(t), r = "", n = 0; n < e.length; ++n) {
          ...
          45 === o || 46 === o || 95 === o || 126 === o || o >= 48 && o <= 57 || o >= 65 && o <= 90 || o >= 97 && o <= 122 ? r += e.charAt(n) : o < 128 ? r += i[o] : o < 2048 ? r += i[192 | o >> 6] + i[128 | 63 & o] : o < 55296 || o >= 57344 ? r += i[224 | o >> 12] + i[128 | o >> 6 & 63] + i[128 | 63 & o] : (n += 1,
          o = 65536 + ((1023 & o) << 10 | 1023 & e.charCodeAt(n)),
          r += i[240 | o >> 18] + i[128 | o >> 12 & 63] + i[128 | o >> 6 & 63] + i[128 | 63 & o])
      }
      return r
  }
  ,
  e.compact = function(t) {
      for (var e = [{
          ...
          for (var i = e[n], o = i.obj[i.prop], s = Object.keys(o), a = 0; a < s.length; ++a) {
              var u = s[a]
                , c = o[u];
...
, function(t, e, r) {
  ...
  e.del = function(t) {
      o.sessionConfigPromise(function() {
          ...
          if (r) {
              var s = {};
              s.sid = o.getSessionID(),
              s.ad = o.getDeviceUUID();
              var a = {
                  session: s
              };
              i.log("users_del", a, i.DEBUG),
              n.del(e.users_path + "/" + r, {}, a, function(e, r) {
                  return e ? i.error("Couldn't properly rest user.", r, i.DEBUG) : i.log("Successfully reset the user.", r, i.DEBUG),
                  t && t(e, r)
              })
          }
      })
      ...
      o.sessionConfigPromise(function() {
          ...
          n.post(e.users_path, {}, l, function(t, e) {
              if (t)
                  ...
                  var n = e.body;
                  n ? (i.time("Users.post: successfully created/updated user.", e, c, i.DEBUG),
                  o.setAppUserID(n.app_user_id),
                  o.setSessionID(n.session_id),
                  o.tick()) : i.error(r, null, i.USER)
              }
              return s && s(t, e)
          })
      })
...
, function(t, e, r) {
  ...
  var n = r(3)
    ...
    , a = r(2);
  function u(t) {
      if (!t || !t.winning_variation)
          return null;
      if ("baseline" === t.winning_variation)
          return "b";
      var e = !0
        , r = !1
        , n = void 0;
      try {
          for (var i, o = t.variations[Symbol.iterator](); !(e = (i = o.next()).done); e = !0) {
              var s = i.value;
              if (s && t.winning_variation === s._id)
                  return s
          }
      } catch (t) {
          r = !0,
  ...
  function c(t) {
      if (0 === t.variations.length)
          return "baseline";
      var e = Math.random()
        , r = a.isNumber(t.baseline.distributionPercent) ? t.baseline.distributionPercent : 0;
      if (r && e < r)
          return i.log("Show Baseline For Experiment: " + t._id, null, i.DEBUG),
          "baseline";
      var n = r
        , o = !0
        , s = !1
        , u = void 0;
      try {
          for (var c, l = t.variations[Symbol.iterator](); !(o = (c = l.next()).done); o = !0) {
              var f = c.value;
              if (f.distributionPercent && e < (n += f.distributionPercent))
                  return i.log("Show Variation: " + f._id + ", for experiment: " + t._id, null, i.DEBUG),
                  f
          }
      } catch (t) {
          s = !0,
      ...
      return i.error("Didn't find variation in experiment", null, i.DEBUG),
      "baseline"
  }
  e.fastMode = !1,
  e.startOptions = null,
  ...
  e.get = function(t) {
      var r = t.skipFastMode
        ...
        , u = t.user_attributes
        , c = u && u.user_id;
      if (c ? o.setUserID(c) : c = o.getOrCreateUserID(),
      a)
      ...
      n.get("config", f, function(t, e) {
          if (t)
              ...
              r ? (s.clientConfig(l),
              i.time("config.get: successfully got session config data", e, l, i.DEBUG)) : i.error("No config data in response", null, i.DEBUG)
          }
      })
  }
  ,
  e.handleDynamicConfig = function(t) {
      t && (i.log("handle dynamic config", t, i.DEBUG),
  ...
  e.postFastModeConfig = function() {
      var t = new Date
        ...
        , a = o.config;
      if (!a)
          return i.error("Missing config to POST", null, i.DEBUG);
      ...
      n.post("config", r, {
          ...
          if (e)
              ...
              var n = r.body;
              n ? (a.app_user_id = n.app_user_id,
              a.session_id = n.session_id,
              o.saveSessionConfig(a),
              s.clientConfig(t),
              i.time("config.post: successfully posted session config data", r, t, i.DEBUG)) : (i.error("No config data in post response", null, i.DEBUG),
              o.saveSessionConfig(a, !0))
          }
      })
  }
  ...
  e.getFastModeConfig = function() {
      ...
      n.getJSON(n.publicToken + ".json", function(n, a) {
          if (!n && a && a.body) {
              ...
              u ? (o.saveSessionConfig(u),
              i.time("config.get: successfully got fast mode config data", a, t, i.DEBUG),
              s.fastModeConfig(t),
              e.postFastModeConfig()) : (i.error("No config data in fast mode response", null, i.DEBUG),
              r())
          } else
              i.error("Failed to get config", n, i.DEBUG),
              r()
      })
  }
  ,
  e.buildConfig = function(t) {
          ...
          if (t && t.length) {
              ...
              try {
                  for (var o, s = t[Symbol.iterator](); !(e = (o = s.next()).done); e = !0) {
                      var a = o.value;
                      a.isActive && (l[a.name] ? i.log("Warning dynamic variable is used in two experiments, name: " + a.name, null, i.LOG) : l[a.name] = a)
                  }
              } catch (t) {
                  r = !0,
                  n = t
      ...
      function p(t, e) {
          "b" === e || "baseline" === e ? (a[t.id] = "b",
          r[t.name] = "baseline",
          n[t.name] = "baseline",
          f(t.baseline.dynamicVariables)) : e && (r[t.name] = e.name,
          n[t.name] = e.name,
          a[t.id] = e._id,
      ...
      function h(t, e) {
          ...
          var r = !0
            ...
            , i = void 0;
          try {
              for (var o, s = t.variations[Symbol.iterator](); !(r = (o = s.next()).done); r = !0) {
                  var a = o.value;
                  if (a && (a._id === e || a.name === e))
                      return a
              }
          } catch (t) {
              n = !0,
      ...
      if (t.experiments) {
          var d = !0
            ...
            , m = void 0;
          try {
              for (var y, g = t.experiments[Symbol.iterator](); !(d = (y = g.next()).done); d = !0) {
                  var _ = y.value
                    , b = u(_);
                  if (b)
                      p(_, b);
      ...
      if (t.variables) {
          var x = !0
            ...
            , D = void 0;
          try {
              for (var S, O = t.variables[Symbol.iterator](); !(x = (S = O.next()).done); x = !0) {
                  var E = S.value;
...
, function(t, e, r) {
  ...
  function d(t, e) {
      var r = new Date;
      return t.val = (r.getTime() - e.getTime()) / 1e3,
      p.enqueue(t)
  }
  function v(t) {
      return {
  ...
  function m() {
      if (s.log("events.flushQueue: tick.", p, s.LOUD),
      p.isEmpty() || !l.hasLoadedData)
          return e.scheduleTick();
      var t = p.flush()
        , r = l.getSessionID()
        , n = f.getLS(y);
      n && n.length && (s.log("Add " + n.length + " events from local storage cache", null, s.DEBUG),
      t = t.concat(n),
      f.expire(y, !0)),
      r || i.post({}, "Taplytics::events.flushQueue: failed to create sessions. Events will fail to process."),
  ...
  e.watchLifecycleEvents = function() {
      ...
      window.addEventListener("unload", function() {
          ...
          e.appTerminate(),
          function() {
              if (p.isEmpty() || !l.hasLoadedData)
                  return;
              var t = p.flush();
              s.log("save " + t.length + " events to local storage", p, s.DEBUG),
              f.setLS(y, t)
          }()
      })
  }
  ...
  e.pageClose = function(t, e, r, n, i) {
      var o = v(h.pageClose);
      return o.val = (new Date).toISOString(),
      o.vKey = e,
      o.tKey = t,
      o.tvKey = n,
      o.tvCl = r,
  ...
  e.clientConfig = function(t) {
      if (t)
          return d(v(h.config), t)
  }
  ,
  e.fastModeConfig = function(t) {
      if (t)
          return d(v(h.fastConfig), t)
  }
  ,
  e.post = function(t, e) {
      var r = new Date;
      n.post("events", {}, function(e) {
          var r = {};
          return r.sid = l.getSessionID(),
          {
              session: r,
              events: t
          }
      }, function(t, n) {
          return t ? s.error("Taplytics::events.post: failed to log events", t, s.LOG) : s.time("Taplytics::events.post: succesfully logged events.", n, r, s.DEBUG),
          e && e(t, n)
      })
  }
  ;
...
, function(t, e, r) {
  ...
  e.post = function(t, e) {
      if (!t)
          return i.error("No new variable to post to server", null, i.DEBUG);
      var r = new Date
        , o = {
          name: t.name,
          createdAt: new Date,
          variableType: t.defaultType,
          defaultVal: t.stringifyValue ? t.stringifyValue(t.defaultValue) : t.defaultValue
      };
      i.log("variable_post", o, i.DEBUG),
      n.post("variable", {}, o, function(t, n) {
          if (t)
              i.error("Failed to post variable", t, i.DEBUG);
          else {
              var o = n.body;
              o && o.name && i.time("Users.post: successfully created new variable.", o, r, i.DEBUG)
          }
          return e && e(t)
      })
  }
...
, function(t, e, r) {
  ...
  e.flushAppQueue = function() {
      if (i.log("flushAppQueue tick", window._tlq, i.LOUD),
      window._tlq && window._tlq instanceof Array) {
          var t = window._tlq.slice();
          if (window._tlq = [],
          Array.prototype.sort && t.sort(function(t, e) {
              if (t instanceof Array && e instanceof Array) {
                  if ("init" === t[0] && "identify" === e[0])
                      return -1;
                  if ("identify" === t[0] && "init" === e[0])
                      return 1;
                  if ("init" === t[0] || "identify" === t[0])
                      return -1
              }
              return 2
          }),
              ...
              for (var r = 0; r < t.length; r++) {
                  ...
                  if (n[a] && n[a]instanceof Function)
                      try {
                          ...
                          i.error("Attempted to call " + a + "(" + (u || []).join(",") + "); from the queue but failed!", t, i.USER),
...
, function(t, e, r) {
  ...
  function d(t) {
      for (var e, r, n = {}, i = t.split("&"), o = 0, s = i.length; o < s; ++o)
          -1 == (r = (e = i[o]).indexOf("=")) ? n[decodeURIComponent(e)] = "" : n[decodeURIComponent(e.slice(0, r))] = decodeURIComponent(e.slice(r + 1));
      return n
  }
  function v(t) {
  ...
  m.prototype._parseBody = function(t) {
      ...
      return this.req._parser ? this.req._parser(this, t) : (!e && v(this.type) && (e = l.parse["application/json"]),
  ...
  y.prototype._end = function() {
      ...
      !this._formData && "GET" != this.method && "HEAD" != this.method && "string" != typeof r && !this._isHost(r)) {
          ...
          !o && v(i) && (o = l.serialize["application/json"]),
          o && (r = o(r))
      }
  ...
  var n = r(18)
    ...
    , u = function t(e, r, i, o, s, u, c, l, f, p, h, d) {
      ...
      if ("function" == typeof c)
          ...
          if (o)
              return u && !d ? u(r, a.encoder) : r;
          v = ""
      }
      if ("string" == typeof v || "number" == typeof v || "boolean" == typeof v || n.isBuffer(v))
          return u ? [h(d ? r : u(r, a.encoder)) + "=" + h(u(v, a.encoder))] : [h(r) + "=" + h(String(v))];
      var m, y = [];
      if (void 0 === v)
          return y;
      if (Array.isArray(c))
      ...
      for (var _ = 0; _ < m.length; ++_) {
          var b = m[_];
          s && null === v[b] || (y = Array.isArray(v) ? y.concat(t(v[b], i(r, b), i, o, s, u, c, l, f, p, h, d)) : y.concat(t(v[b], r + (f ? "." + b : "[" + b + "]"), i, o, s, u, c, l, f, p, h, d)))
      }
      return y
  };
  t.exports = function(t, e) {
      ...
      var g, _, b = i.formatters[s.format];
      "function" == typeof s.filter ? r = (_ = s.filter)("", r) : Array.isArray(s.filter) && (g = _ = s.filter);
      var w, x = [];
      ...
      for (var D = 0; D < g.length; ++D) {
          var S = g[D];
          f && null === r[S] || (x = x.concat(u(r[S], S, k, l, f, p ? h : null, _, d, v, m, b, y)))
      }
      var O = x.join(c)
...
, function(t, e, r) {
    ...
    , s = function(t, e, r) {
      if (t) {
          var n = r.allowDots ? t.replace(/\.([^.[]+)/g, "[$1]") : t
            ...
            , u = [];
          if (a) {
              if (!r.plainObjects && i.call(Object.prototype, a) && !r.allowPrototypes)
                  return;
              u.push(a)
          }
          ...
          return s && u.push("[" + n.slice(s.index) + "]"),
          function(t, e, r) {
              for (var n = e, i = t.length - 1; i >= 0; --i) {
                  ...
                  if ("[]" === s)
                      ...
                      var a = "[" === s.charAt(0) && "]" === s.charAt(s.length - 1) ? s.slice(1, -1) : s
                        , u = parseInt(a, 10);
                      !isNaN(u) && s !== a && String(u) === a && u >= 0 && r.parseArrays && u <= r.arrayLimit ? (o = [])[u] = n : o[a] = n
                  }
                  n = o
              }
              return n
  ...
  t.exports = function(t, e) {
      ...
      r.delimiter = "string" == typeof r.delimiter || n.isRegExp(r.delimiter) ? r.delimiter : o.delimiter,
      r.depth = "number" == typeof r.depth ? r.depth : o.depth,
      r.arrayLimit = "number" == typeof r.arrayLimit ? r.arrayLimit : o.arrayLimit,
      r.parseArrays = !1 !== r.parseArrays,
      r.decoder = "function" == typeof r.decoder ? r.decoder : o.decoder,
      r.allowDots = "boolean" == typeof r.allowDots ? r.allowDots : o.allowDots,
      r.plainObjects = "boolean" == typeof r.plainObjects ? r.plainObjects : o.plainObjects,
      r.allowPrototypes = "boolean" == typeof r.allowPrototypes ? r.allowPrototypes : o.allowPrototypes,
      r.parameterLimit = "number" == typeof r.parameterLimit ? r.parameterLimit : o.parameterLimit,
      r.strictNullHandling = "boolean" == typeof r.strictNullHandling ? r.strictNullHandling : o.strictNullHandling,
      "" === t || null === t || void 0 === t)
          return r.plainObjects ? Object.create(null) : {};
      for (var a = "string" == typeof t ? function(t, e) {
          for (var r = {}, n = e.ignoreQueryPrefix ? t.replace(/^\?/, "") : t, s = e.parameterLimit === 1 / 0 ? void 0 : e.parameterLimit, a = n.split(e.delimiter, s), u = 0; u < a.length; ++u) {
              var c, l, f = a[u], p = f.indexOf("]="), h = -1 === p ? f.indexOf("=") : p + 1;
              -1 === h ? (c = e.decoder(f, o.decoder),
              l = e.strictNullHandling ? null : "") : (c = e.decoder(f.slice(0, h), o.decoder),
              l = e.decoder(f.slice(h + 1), o.decoder)),
              i.call(r, c) ? r[c] = [].concat(r[c]).concat(l) : r[c] = l
          }
          return r
      }(t, r) : t, u = r.plainObjects ? Object.create(null) : {}, c = Object.keys(a), l = 0; l < c.length; ++l) {
          var f = c[l]
            , p = s(f, a[f], r);
          u = n.merge(u, p, r)
      }
  ...
  t.exports = function(t, e, r, u, c, l) {
      ...
      l.set(e, t); ++v < p; ) {
          var g = t[v]
            , _ = e[v];
          if (u)
              var b = f ? u(_, g, v, e, t, l) : u(g, _, v, t, e, l);
          if (void 0 !== b) {
              if (b)
                  continue;
              m = !1;
  ...
  t.exports = function(t, e, r, s, a, u) {
      ...
      for (var m = c; ++p < f; ) {
          var y = t[h = l[p]]
            , g = e[h];
          if (s)
              var _ = c ? s(g, y, h, e, t, u) : s(y, g, h, t, e, u);
...
, function(t, e, r) {
  var n = r(68)
    ...
    , u = Math.min;
  t.exports = function(t, e, r) {
      var c, l, f, p, h, d, v = 0, m = !1, y = !1, g = !0;
      if ("function" != typeof t)
...
, function(t, e) {
  ...
  r = this,
  n = function() {
      var t, e, r = "lscache-", n = "-cacheexpiration", i = 10, o = 6e4, s = Math.floor(864e13 / o), a = "", u = !1;
      function c() {
      ...
      function v(t, e) {
          ...
          localStorage.setItem(r + a + t, e)
      }
      function m(t) {
          localStorage.removeItem(r + a + t)
      }
      function y(t) {
          for (var e = new RegExp("^" + r + a.replace(/[[\]{}()*+?.\\^$|]/g, "\\$&") + "(.*)"), i = localStorage.length - 1; i >= 0; --i) {
              var o = localStorage.key(i);
              (o = (o = o && o.match(e)) && o[1]) && o.indexOf(n) < 0 && t(o, p(o))
          }
      }
      function g(t) {
          var e = p(t);
      ...
      function b(t, e) {
          u && "console"in window && "function" == typeof window.console.warn && (window.console.warn("lscache - " + t),
...
, function(t, e, r) {
  ...
  t.exports = function() {
      var t = {}
        , e = null;
      return location && location.search && location.search.length && (t = n.parse(location.search.substr(1))),
...
, function(t, e, r) {
  ...
  o.prototype.push = function(t) {
      ...
      setTimeout(function() {
          e || (n.log(r.name + " promise timed out", null, n.LOG),
          o())
      }, i.timeout)
  }
  ,
  o.prototype.completePromises = function(t) {
      var e = !0
        ...
        , n = void 0;
      try {
          for (var i, o = this.promises[Symbol.iterator](); !(e = (i = o.next()).done); e = !0) {
              var s = i.value;
              s && s(t)
          }
      } catch (t) {
...
, function(t, e, r) {
  ...
  function l() {
      if ("undefined" != typeof MutationObserver && !u && document.body) {
          ...
          (u = new MutationObserver(n.debounce(t, 50, {
              leading: !0
  ...
  e.applyVisualEditsFromConfig = function(t) {
      if (t && t.webModifications && t.webElements) {
          l(),
          i.log("Apply visual edits from config", null, i.DEBUG);
          ...
          t.webModifications.forEach(function(r) {
              if (r) {
                  ...
                  if (!n)
                      return i.error("No web element found for _id: " + r._element + ", modification: " + r._id, null, i.DEBUG);
                  t.urlRules && s.matchUrlRules(t.urlRules, e) ? a.applyModificationsToDOM({
                      element: n,
                      modification: r
                  }) : (n.hostnameMatch || s.matchUrlsByPath(n.url, e)) && a.applyModificationsToDOM({
                      element: n,
                      modification: r
                  })
              }
...
, function(t, e, r) {
  ...
  e.matchUrlsByPath = function(t, r) {
      ...
      return n && i && n.origin.length && i.origin.length ? n.pathname === i.pathname : (t = t.replace(/^(http(s?):\/\/)?((www\.)?)((.*\/)?)/, "")) === (r = r.replace(/^(http(s?):\/\/)?((www\.)?)((.*\/)?)/, ""))
  }
  ,
  e.matchUrlsByDomain = function(t, e) {
      return t = t.replace(/^(http(s?):\/\/)?((www\.)?)/, "").split("/")[0],
  ...
  exports.applyModificationsToDOM = function(_ref) {
      ...
      if (element && modification) {
          var htmlElements = exports.findElementsBySelector(element.selector)
            , htmlElement = htmlElements && htmlElements.length ? htmlElements[0] : null;
          if (htmlElement) {
              log.log("Apply modification for web element: " + htmlElement._id + ", modification: " + modification._id, null, log.LOUD);
              ...
              if (outerHTML && htmlElement.outerHTML !== outerHTML && (htmlElement.outerHTML = outerHTML),
              script)
                  try {
                      eval(script)
                  } catch (t) {
                      log.error("Error on modification script for web element: " + htmlElement._id + ", modification: " + modification._id, t, log.DEBUG)
                  }
          }
      }
  }
  ...
  t.exports = function(t, e) {
      if (function(t) {
          ...
          e) {
              ...
              try {
                  if (e.alias_host) {
                      var r = a.isString(e.alias_host) ? JSON.parse(e.alias_host) : e.alias_host
                        , c = r.api_host
                        , l = r.ping_host;
              ...
              e.user_bucketing && (this.api.config.userBucketing = e.user_bucketing),
              a.isNumber(e.timeout) && this.api.request.setTimeout(e.timeout),
              e.anon_user && !i.getUserID() && i.setUserID(e.anon_user),
              e.track_adobe_analytics && s(e.adobe_obj_name, this.api.events.trackAdobeAnalyticsEvents)
          }
          this._in = {},
          this._in.token = t,
          this._in.logger = n,
          ...
          var h = null;
          try {
              a.isString(e.user_attributes) ? h = e && e.user_attributes && JSON.parse(e.user_attributes) : a.isObjectLike(e.user_attributes) && (h = e.user_attributes)
          } catch (t) {
    ...
    , s = function(t) {
      ...
      return function(t) {
          return Object.keys(t).filter(function(e) {
              return "function" != typeof t[e] && "object" !== n(t[e]) && "events" !== e && "linkTrackEvents" !== e
          })
      ...
      a < 50 && void 0 !== n ? (function(t, e) {
          ...
          t.tl = function(r, i, a, u, c) {
              return o(t).forEach(function(r) {
                  ...
                  t.linkTrackEvents && t.linkTrackEvents.includes(r.name) && e(r.name, r.value, n)
              }),
              n.bind(t)(r, i, a, u, c)
          }
      }(n, r),
...
, function(t, e, r) {
  ...
  t.exports = function(t) {
      if (!this.isReady())
          return i.error("Taplytics::identify: you have to call Taplytics.init first.", null, i.USER),
          this;
      if (!function(t) {
          return !(!t || t && "object" !== (void 0 === t ? "undefined" : n(t)))
      }(t))
          return i.error("Taplytics::identify: you have to pass in an object with user attributes.", null, i.USER),
          this;
      var e = function(t) {
          var e = {
              customData: {}
            ...
            , i = void 0;
          try {
              for (var u, c = Object.keys(t)[Symbol.iterator](); !(r = (u = c.next()).done); r = !0) {
                  var l = u.value
                    , f = t[l]
                    , p = s[l];
                  p ? (a.includes(p) && o.setUserID(f),
                  e[p] = f) : e.customData[l] = f
              }
          } catch (t) {
              n = !0,
              i = t
      ...
      return this.api.users.post(e, "Taplytics::identify: failed to save the user attributes properly."),
      this
  }
  ;
  var s = {
...
, function(t, e, r) {
  ...
  t.exports = function(t, e, r) {
      if (!this.isReady())
          return n.error("track: you have to call Taplytics.init first.", null, n.USER),
          !1;
      if (!t)
          return n.error("track: you have to specify an event name.", null, n.USER),
          !1;
      var s = e
        , a = r;
      return o.isObjectLike(e) && !r && (s = void 0,
      a = e),
      s && !o.isNumber(s) ? (n.error("track: if you're passing a value, it has to be a number.", null, n.USER),
      !1) : (i.tick(),
      this.api.events.goalAchieved(t, s, a),
      this)
  }
}
, function(t, e, r) {
  ...
  t.exports = function(t, e, r) {
      if (!this.isReady())
          return i.error("track: you have to call Taplytics.init first.", null, i.USER),
          this;
      var u = t
        , c = e
        , l = r;
      if ("object" !== (void 0 === e ? "undefined" : n(e)) || r ? t && !e && (u = void 0,
      c = t) : (u = void 0,
      c = t,
      l = e),
      s.tick(),
      s.get(a.previous_page_href)) {
          ...
          this.api.events.pageClose(f.category, f.name, f.href, f.title, f.location),
          this.api.events.timeOnPage(f.category, f.name, f.href, f.title, f.location, f.view_date),
      ...
      return this.api.events.pageView(u, c, l),
      function(t, e) {
          ...
          s.set(a.previous_page_location, o.toObject(), JSON && JSON.stringify),
...
, function(t, e, r) {
  ...
  var n = r(0)
    , i = r(1);
  t.exports = function() {
      return this.isReady() ? (i.tick(),
      this.api.users.del(),
      i.resetSession(),
      this.api.config.get({}),
      this) : (n.error("Taplytics::reset: you have to call Taplytics.init first.", null, n.USER),
      !1)
  }
}
, function(t, e, r) {
...
, function(t, e, r) {
  ...
  function a(t, e, r) {
      ...
      this.defaultType ? (this.init = !0,
      void this.getValueFromConfig()) : i.log("Error: Taplytics variables only support Strings, Numbers, and Booleans.", null, i.USER)) : i.log("Error: Taplytics variable is missing a name", null, i.USER)
  }
  a.prototype.getValueType = function(t) {
      return "string" == typeof t ? "String" : "number" == typeof t ? "Number" : "boolean" == typeof t ? "Boolean" : "object" === (void 0 === t ? "undefined" : n(t)) ? "JSON" : null
  }
  ,
      ...
      o.configPromise(function() {
          ...
          if (n) {
              if (n.variableType !== t.defaultType)
                  return e(),
                  i.error("Taplytics variable " + t.name + " default type does not match server: " + n.variableType, null, i.LOG);
              t.value = t.parseValue(n.value)
          } else
              r && (i.log("New Taplytics Variable: " + t.name, null, i.DEBUG),
              s.post(t));
          e()
      })
  }
...
, function(t, e, r) {
  ...
  t.exports = function(t, e) {
      if (!t)
          return n.error("No name to run code block", null, n.USER);
          ...
          if (r) {
              ...
              if (s) {
                  if ("Code Block" !== s.variableType)
                      return n.error("Taplytics code block " + t + " default type does not match server: " + s.variableType, null, n.LOG);
                  e && s.value && e()
              } else
...
, function(t, e, r) {
  ...
  t.exports = function(t) {
      if (!t)
          return n.error("No key to return feature flag enabled", null, n.USER),
          !1;
      var e = i.config;
      if (!e || !e.ff)
          return !1;
  ...
  t.exports = function(t) {
      n.configPromise(function() {
          var e = n.config && n.config.ff ? n.config.ff : {}
            , r = {};
          return i.values(e).forEach(function(t) {
...
, function(t, e, r) {
  ...
  var n = r(4)
    , i = r(12).OPT_OUT_KEY;
  t.exports = function() {
      return n.hasUserOptedOutTracking() && (n.setLS(i, !1),
...
, function(t, e, r) {
  ...
  t.exports = function() {
      ...
      i.resetSession(),
      this.api.config.get({}),
      this) : (n.error("Taplytics::startNewSession: you have to call Taplytics.init first.", null, n.USER),
      this)
  }
}
]);
...
Taplytics.init("fd1e0c78e8c041798002726a30d9d4ff", {
  "config": {
      "expVarsNames": {
          ...
          "Sample Experiment": "baseline",
          "New new visual experiment": "Variation 1"
      },
      "expVarsIds": {
          "5d583ac4921c0300779b48ab": "5d583ac4921c0300779b48ae",
          "5d4b1f20a4782c002cc9e991": "b",
          "5d4b227b5073be0071039bcd": "b"
      },
      "dynamicVars": {},
      "ff": {
          "showKitten": {
      ...
      "webElements": [{
          "_id": "5d583b6b921c0300779b48b0",
          "selector": "body>div#root:nth-child(2)>div:nth-child(1)>div:nth-child(2)>img:nth-child(2)",
          "url": "https://nikolasleblanc.github.io/tap-spa/about/",
          "__v": 0,
          "hostnameMatch": false
      }, {
          "_id": "5d5838512e8418000ec9db43",
          "selector": "body>div#root:nth-child(2)>div:nth-child(1)>div:nth-child(2)>h1:nth-child(1)",
          "url": "https://nikolasleblanc.github.io/tap-spa/about/",
          "__v": 0,
          "hostnameMatch": false
      }, {
          "_id": "5d582ccc9f3fdc000d6d2115",
          "selector": "nav:nth-child(1)>ul:nth-child(1)>li:nth-child(2)>a:nth-child(1)",
          "url": "https://nikolasleblanc.github.io/tap-spa/about/",
          "__v": 0,
          "hostnameMatch": false
      }],
      "webModifications": [{
          "_id": "5d583b6b921c0300779b48b1",
          "_element": "5d583b6b921c0300779b48b0",
          "__v": 0,
          "attributes": {
              "outerHTML": "<img alt=\"\" src=\"https://via.placeholder.com/468x468/0000FF/FFFFFF?text=From+Visual+Editor\">",
              "innerText": "",
              "src": "https://via.placeholder.com/468x468/0000FF/FFFFFF?text=From+Visual+Editor",
              "childSrc": null,
              "script": null
          },
          "isBaseline": false
      }, {
          "_id": "5d583b7d921c0300779b48b3",
          "_element": "5d5838512e8418000ec9db43",
          "__v": 0,
          "attributes": {
              "outerHTML": "<h1>Aboot (Visual Editor)</h1>",
              "innerText": "Aboot (Visual Editor)",
              "childSrc": null,
              "script": null
          },
          "isBaseline": false
      }, {
          "_id": "5d583b87921c0300779b48b5",
          "_element": "5d582ccc9f3fdc000d6d2115",
          "__v": 0,
          "attributes": {
              "outerHTML": "<a href=\"/tap-spa/about/\">Aboot (Visual Editor)</a>",
              "innerText": "Aboot (Visual Editor)",
          ...
          "_id": "5d596e532e8418000ec9f73d",
          "_element": "5d5838512e8418000ec9db43",
          "__v": 0,
          "attributes": {
              "outerHTML": "<h1>Aboot (Visual Editor) 123</h1>",
              "innerText": "Aboot (Visual Editor) 123",
              "childSrc": null,
              "script": null
          },
          "isBaseline": false
      }],
      "app_user_id": "5d59875ae9152400142a99e1",
      "ad": "531f305f-543c-4351-8132-a29b18f5531c"
  }
});
